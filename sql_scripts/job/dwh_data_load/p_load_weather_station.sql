-- PROCEDURE: job.p_load_dwh_weather_station(integer)

-- DROP PROCEDURE IF EXISTS job.p_load_dwh_weather_station(integer);
...
ALTER PROCEDURE job.p_load_dwh_weather_station(integer)
    OWNER TO postgres;
