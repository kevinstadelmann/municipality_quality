...
class DBLogger:
    ...
    def write_log(self, job_level: str, job_id: int, error_level: int, log_text: str):
        try:
        ...
        parameter1 = job_level
        parameter2 = job_id
        parameter3 = error_level
        parameter4 = log_text
        logging.info(connection)
        try:
            connection.execute(text("CALL job.p_log (:p1, :p2, :p3, :p4)"),p1=parameter1, p2=parameter2, p3=parameter3, p4=parameter4)
